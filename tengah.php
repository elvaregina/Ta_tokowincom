...
echo'<div class="banner">
  ...
  $deskripsi=substr($r[deskripsi],0,50);
  	echo"
                  <div class=''><img src='foto_produk/$r[gambar]' alt='lapy' title='product' width='220' height='240' />
...
elseif ($_GET[module]=='warning') {
	echo "<div id='info'>! Untuk Membooking wisata ini Anda Harus Login Terlebih Dahulu <a href='media.php?module=login'>disini</a></div>";
}
// Modul detail produk
...
elseif ($_GET[module]=='detailkategori'){
  ...
  while ($r=mysql_fetch_array($sql)){
    ...
    echo "<p align=center>Belum ada wisata pada kategori ini.</p>";
  }
}
...
elseif ($_GET[module]=='keranjangbelanja'){
  ...
  if($ketemu < 1){
    echo "<script>window.alert('silahkan pesan wisata');
        window.location=('index.php')</script>";
    }
  else{  
    echo "<div class='center_title_bar'>wisata liburan</div>
        ...
        <div class='center_prod_box_big'>            
          ...
          <tbody>
          <tr bgcolor='#0c1d2d'><th>No</th><th>wisata</th><th>Nama wisata</th><th>Berat(Kg)</th><th>Qty</th>
  ...
  echo "<tr style='color:#000'><td colspan=6 align=right><br><b>Total</b>:</td><td colspan=2><br>Rp. <b>$total_rp</b></td></tr>
        <tr><td colspan=3><br /><a href='javascript:history.go(-1)' class='button'></a><br /></td>
        <td colspan=5 align=right><br /><a href='media.php?module=simpantransaksimember' class='button'>Selesai memesan</a></a><br /></td></tr>
        </tbody></table></form><br />
        <div id='info'>*)  <b>Selesai booking</b>.</div>
        </div>
...
elseif ($_GET['module']=='hasilcari'){
  ...
  echo "<div class='prod_details_cari'>Ditemukan <b>$ketemu</b> produk dengan kata <font style='background-color:#00FFFF'><b>$kata</b></font> : </div>";
    ...
    echo "<p>Tidak ditemukan wisata dengan kata <b>$kata</b></p>";
  }
}
...
elseif ($_GET[module]=='pemesanan'){
  echo "<div class='login-box'>
  		<h2>Hubungi Kami</h2>    
		Kami Menerima Pemesanan wisata, baik itu wisata alam, wisata religi dll, Anda dapat menghubungi Kami lewat Form di bawah ini      
          <div class='details_big_box'>
            <div class='product_title_big'>Pesan tempar wisata Yang Anda Inginkan Sekarang, Hubungi Kami Secara Online:</div>
              </div>
			  </div>";
if (empty($_SESSION[username]) AND empty($_SESSION[password])) {
  ...
  echo "<div class='login-box'>
		...
		<tr><td colspan=2>
		<br/><b>Silahkan Anda Memesan wisata Dibawah Ini</b><br>
        ...
        <div class='center_prod_box_big'>            
          ...
          <div class='details_big_box'>
            <div class='product_title_big'>Terimakasih</div>
              <div>
              <br />Terimakasih telah menghubungi kami.<br /><br /> Kami akan segera Merespon Pemesanan Anda selamat berlibur.
              </div>
          </div>    
          </div>
            <div class='bottom_prod_box_big'></div>
...
echo "<div id='info'>";
	   ...
	   echo "<script> alert('Silahkan pesan wisata');window.location='index.php'</script>\n";
		 exit(0);
		}
echo "</div>";
	}
...
echo "<div class='login-box'>";
  ...
  $ketemu=mysql_num_rows($sql);
  if($ketemu < 1){
   echo "<script> alert('anda belum memesan wisata');window.location='index.php'</script>\n";
   	 exit(0);
	}
	else{
...
";                      
  ...
  echo "<h2>Kustomer Baru</h2>";
      ...
      <tr><td>Alamat Pengiriman</td><td>  <textarea name=alamat></textarea>
      <br /> Alamat  harus di isi lengkap, termasuk kota/kabupaten dan kode posnya.</td></tr>
...
for ($i = 0; $i < $jml; $i++) {
  ...
  echo "<div class='center_title_bar'>Proses Transaksi Selesai</div>";
        ...
        <div class='center_prod_box_big'>            
          <div class='details_big_cari'>
              <div>
      Data pemesan tiket wisata adalah sebagai berikut: <br />
      <table>
...
echo "<table cellpadding=10>
      <tr bgcolor=#0c1d2d><th>No</th><th>Nama wisata</th><th>jumlah tiket</th><th>Harga tiket</th><th>Sub Total</th></tr>";
      
$pesan="Terimakasih telah melakukan pemesanan di website kami <br /><br />  
...
while ($d=mysql_fetch_array($daftarproduk)){
   ...
   echo "<tr bgcolor=#0c1d2dh><td>$no</td><td>$d[nama_produk]</td><td align=center>$d[berat]</td><td align=center>$d[jumlah]</td>
...
echo "<tr><td colspan=5 align=right>Total : Rp. </td><td align=right><b>$total_rp</b></td></tr>
      <tr><td colspan=5 align=right>Tujuan Kota Anda: Rp. </td><td align=right><b>$ongkoskirim1_rp</b>/Kg</td></tr>      
