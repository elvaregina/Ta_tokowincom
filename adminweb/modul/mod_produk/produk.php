...
switch($_GET[act]){
  // Tampil Produk
  default:
    echo "<h2>Wisata Kami</h2>
          <input type=button value='Tambah Wisata' onclick=\"window.location.href='?module=produk&act=tambahproduk';\">
          <table>
          <tr><th>no</th><th>nama wisata</th><th>deskripsi</th><th>harga</th><th>fasilitas</th><th>tgl. masuk</th><th>aksi</th></tr>";
  ...
  case "tambahproduk":
    echo "<h2>Tambah Wisata</h2>
          <form method=POST action='$aksi?module=produk&act=input' enctype='multipart/form-data'>
          <table>
          <tr><td width=100>Nama Wisata</td>     <td> : <input type=text name='nama_produk' size=60></td></tr>
    ...
    echo "</select></td></tr>
          ...
          <tr><td>Fasilitas</td>     <td> : <input type=text name='harga' size=50></td></tr>
          <tr><td>Harga</td>     <td> : <input type=text name='diskon' size=20></td></tr>
          <tr><td>Tanggal Masuk</td>     <td> : <input type=text name='stok' size=20></td></tr>
